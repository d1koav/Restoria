...
public class CookAdapter extends BaseAdapter {
    ...
    public CookAdapter(Context context, List<CookDataModel> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.cook_list_item, parent, false);
            holder = new ViewHolder();
            holder.textOrderID = convertView.findViewById(R.id.textOrder_ID);
            holder.textDishName = convertView.findViewById(R.id.textDish_Name);
            holder.textCountDish = convertView.findViewById(R.id.text_Count_Dish);
            holder.textStatus = convertView.findViewById(R.id.textStatus_Dish);
            holder.buttonReady = convertView.findViewById(R.id.button_Ready);
        ...
        if (data.getStatus().equals("Готово")){
            holder.buttonReady.setVisibility(View.INVISIBLE);
        }else{
